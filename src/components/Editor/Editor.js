...
function Editor(props) {
  ...
  const profileBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Name"
          placeholder="Enter your full name eg. Rehan"
          value={values.name}
          onChange={(event) =>
  ...
  const AboutBody = (
    <div className={styles.detail}>
      <InputControl
        label="About"
        value={values.About}
        placeholder="Enter your objective/About"
        onChange={(event) =>
  ...
  useEffect(() => {
    ...
    setValues({
      ...
      About: typeof activeInfo?.detail !== "object" ? activeInfo.detail : "",
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.body}>
        ...
        <button onClick={handleSubmission} className="saveBtn">
          Save
        </button>
      </div>
    </div>
