...
const Resume = forwardRef((props, ref) => {
  ...
  const info = {
    ...
    About: information[sections.About],
  ...
  const sectionDiv = {
    ...
    [sections.About]: (
      <div
        key={"About"}
        draggable
        onDragOver={() => seTarget(info.About?.id)}
        onDragEnd={() => setSource(info.About?.id)}
        className={`${styles.section} ${
          info.About?.sectionTitle ? "" : styles.hidden
        }`}
      >
        <div className={styles.sectionTitle}>{info.About?.sectionTitle}</div>
        <div className={styles.content}>
          <p className={styles.overview}>{info.About?.detail}</p>
        </div>
      </div>
    ),
    [sections.other]: (
  ...
  useEffect(() => {
    setColumns([
      [sections.project, sections.education, sections.About],
    ...
    <div ref={ref}>
      <div ref={containerRef} className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.subHeading}>{info.profile?.detail?.title}</p>
